    ...
    if request.method == 'POST':
        ...
        if registerForm.is_valid():
            ...
            if verifyUsername is not None:
                ...
                message = {'type': 'danger', 'text': 'Já existe usuário com este e-mail.'}
            else:
        ...
        if recoveryForm.is_valid():
            ...
            if profile is not None:
                try:
                    ...
                    message = { 'type': 'danger', 'text': 'Erro no envio de e-mail.'}
            else:
...
def send_email(profile):
    ...
    try:
        ...
        send_mail(
            ...
            from_email=settings.EMAIL_HOST_USER, recipient_list=[profile.user.email],
            fail_silently=False,
        )
    except:
        raise Exception
